...
1. From your **WebVM** RDP session, in the search bar, **Search (1)** for **RDP (2)** and **select** the **Remote Desktop Connection (3)** app.
...
1. Now navigate back to WebVM and then launch Azure Data Studio from the Windows. click on  **Start** menu.
...
1. In the [Azure portal](https://portal.azure.com), navigate to your Azure Database Migration Service by select the **hands-on-lab** resource group, and then selecting the **parts-dms-<inject key="DeploymentID" enableCopy="false"/>** Azure Database Migration Service from the list of resources.
...
1. On the Migration Wizard **Source details** Blade, enter the following:
   ...
   - **Resource group**: Select **hands-on-lab** **(3)**.
...
1. On the Migration Wizard **Select target** Blade, enter the following:
   ...
   - **Resource Group**: Select your **hands-on-lab** resource group **(2)**
